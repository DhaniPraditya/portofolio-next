...
import { CheckCircle2, User, Layout, Smartphone, Search } from "lucide-react";
    ...
    <main className="relative min-h-screen bg-background">
      ...
      <footer className="py-20 border-t border-white/5 text-center px-4">
        ...
        <div className="flex justify-center gap-8 mb-12">
          {["LinkedIn", "Dribbble", "Behance", "Email"].map(link => (
            <a key={link} href="#" className="text-foreground/40 hover:text-primary transition-colors font-medium">
              {link}
            </a>
          ))}
        </div>
